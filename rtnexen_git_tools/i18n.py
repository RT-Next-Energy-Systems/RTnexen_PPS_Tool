...
STRINGS = {
    ...
    "log_upstream_set":       {LANG_ZH: "▶ 設定 upstream：origin/{branch}", LANG_EN: "▶ Setting upstream: origin/{branch}"},
    "log_upstream_fail":      {LANG_ZH: "⚠  無法設定 upstream，嘗試直接指定 remote/branch pull...", LANG_EN: "⚠  Could not set upstream, pulling with explicit remote/branch..."},
    "log_reset_to_remote":    {LANG_ZH: "▶ 正在強制同步至遠端 (git fetch + git reset --hard)...", LANG_EN: "▶ Force-syncing to remote (git fetch + git reset --hard)..."},
    "log_reset_done":         {LANG_ZH: "\n✓  已強制同步至遠端，本地 commit 已被覆蓋。", LANG_EN: "\n✓  Force-synced to remote. Local commits overwritten."},
    "log_reset_failed":       {LANG_ZH: "\n✗  強制同步失敗：{err}", LANG_EN: "\n✗  Force-sync failed: {err}"},
    ...
    "btn_check_update": {LANG_ZH: "檢查更新", LANG_EN: "Check for Updates"},
    "check_update_latest": {LANG_ZH: "已是最新版本（v{version}）", LANG_EN: "You are on the latest version (v{version})"},
